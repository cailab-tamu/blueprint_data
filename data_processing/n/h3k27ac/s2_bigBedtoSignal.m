...
% 5/24/2017 - JJCai the following problem has been fixed by editing
% filelistbed.m
%
% moverow = bigbedfiles(5); %%for unknown reasons one of the files was out of order with the metadata, instead of re-ordering every time I just switched the order here
% bigbedfiles(5)=[];
% bigbedfiles = [bigbedfiles(1:113), moverow, bigbedfiles(113+1:end)];
